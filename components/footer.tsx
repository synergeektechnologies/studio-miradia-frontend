      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-white mb-4">Elegance in Every Thread</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-sm text-white hover:text-gray-200 transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/shop" className="text-sm text-white hover:text-gray-200 transition-colors">
                  Shop
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/refund" className="text-sm text-white hover:text-gray-200 transition-colors">
                  Returns & Refunds
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white">© 2025 Studio MiraDia. All rights reserved.</p>
          <div className="flex gap-4">
            ...
            <Link href="https://facebook.com" className="text-white hover:text-gray-200 transition-colors">
