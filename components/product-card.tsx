      ...
      <Link href={`/product/${product.id}`}>
        <div className="group relative overflow-hidden h-full flex flex-col">
          ...
          <div className="mt-3 text-center flex flex-col grow">
            <h3 className={`font-medium text-base mb-1 min-h-10 overflow-hidden ${textColor === "black" ? "text-black/90" : "text-white/90"}`} style={{
              display: '-webkit-box',
              WebkitLineClamp: 2,
      ...
      >
        ...
        <div className="relative aspect-3/4 overflow-hidden bg-secondary shrink-0">
          ...
          {isHovered && product.inStock && (
            <div className="absolute inset-0 bg-[#d8a7a7]/40 flex items-center justify-center gap-3 animate-in fade-in duration-200">
              <Button
                size="icon"
                className="bg-[#d8a7a7] hover:bg-[#d8a7a7]/90 text-white rounded-full"
